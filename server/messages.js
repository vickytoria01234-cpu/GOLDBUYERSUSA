...
exports.GOOGLE_TOKEN_INVALID_AUDIENCE = 'Invalid Google token audience';
...
exports.DISPOSABLE_EMAIL_NOT_ALLOWED = 'Disposable email addresses are not allowed';
...
exports.DEPOSIT_DISABLED_FOR_COIN_ON_NETWORK = (coin, network, availableNetworks) => `Deposit for coin ${coin} is disabled on the ${network} network. Available networks for deposit: ${availableNetworks}`;
exports.WITHDRAWAL_DISABLED_FOR_COIN_ON_NETWORK = (coin, network, availableNetworks) => `Withdrawal for coin ${coin} is disabled on the ${network} network. Available networks for withdrawal: ${availableNetworks}`;
exports.WITHDRAWAL_DAILY_LIMIT_REACHED = 'You have reached your daily withdrawal limit';
exports.WITHDRAWAL_MONTHLY_LIMIT_REACHED = 'You have reached your monthly withdrawal limit';
...
exports.TIER_NOT_FOUND = 'Fee tier configuration could not be found for the user or broker verification level';
...
exports.REFERRAL_CONNECT_FAILED = 'Unable to connect referral code';
...
exports.WITHDRAWAL_IDENTITY_NOT_VERIFIED = 'Identity verification is required before making a withdrawal. Please complete your identity verification.';
exports.WITHDRAWAL_OTP_REQUIRED = 'Two-factor authentication (OTP) must be enabled to withdraw';
exports.WITHDRAWAL_ADDRESS_NOT_ALLOWED = 'Withdrawals to this address are not allowed';
exports.TRAVEL_RULE_INFO_REQUIRED = 'Travel rule information is required for this transaction. Please provide the purpose of the transaction and whether the receiver is yourself.';
exports.TRAVEL_RULE_HOLD_NOT_FOUND = 'No pending travel rule hold found for this transaction';
exports.TRAVEL_RULE_NOT_ACTIVE = 'Travel rule is not active on this exchange';
exports.BLACKLISTED_ADDRESS_ALREADY_EXISTS = 'This address is already blacklisted';
exports.BLACKLISTED_ADDRESS_NOT_FOUND = 'Blacklisted address not found';
exports.BLACKLISTED_ADDRESS_REQUIRED = 'Address is required';
...
exports.ADDRESS_NOT_IN_ADDRESSBOOK = 'Address not found in your address book';
exports.ADDRESS_ALREADY_WHITELISTED = 'Address is already trusted';
exports.INVALID_WHITELIST_TOKEN = 'Whitelist confirmation token is incorrect';
exports.EXPIRED_WHITELIST_TOKEN = 'Expired whitelist confirmation token';
...
exports.SUBACCOUNT_TIER_NOT_EDITABLE = 'Subaccount verification level cannot be changed directly. It follows the master account tier.';
