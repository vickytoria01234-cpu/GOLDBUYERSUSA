...
db[model.name] = model;
model = require(path.join(__dirname, './blacklistedAddress'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './sharedaccount'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './company'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
model = require(path.join(__dirname, './travelRule'))(sequelize, Sequelize.DataTypes);
db[model.name] = model;
