...
const executeUserOrder = async (user_id, opts, token, req) => {
	...
	if (type === 'market') {
		...
		if (!tierBroker || !tierBroker.fees || !tierUser || !tierUser.fees) {
